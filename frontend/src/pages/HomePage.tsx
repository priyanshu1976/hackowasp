      ...
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-24">
        <div className="flex flex-col items-center text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-green-400">GymRat+</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mb-8">
            The ultimate workout tracker for fitness enthusiasts. Monitor your
            progress, set goals, and achieve results.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-sm">
            ...
            <p className="text-gray-400">
              Monitor your personal records and see your improvement over time
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-sm">
            ...
            <p className="text-gray-400">
              Access personalized workout routines designed to help you reach
          ...
          <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-sm">
            ...
            <p className="text-gray-400">
              Connect with like-minded fitness enthusiasts, share tips, and stay
              motivated together.
            </p>
          </div>
        </div>
